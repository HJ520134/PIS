...
{
    public class ConcreteFixtureMaintenanceToDoTwo: ABSFixtureMaintenanceToDo
    {
        ...
        public override void Request(string request)
        {
            ...
            if (!CacheHelper.HasException())
            {
                ...
                {
                    //模具排程信息统计成功，写入排程日志表
                    new ExceptionEmailManager().InsertLogInfo(ConstConstants.FixtureMaintenance, true, null);
                }
                else if (todo != null)
                {
