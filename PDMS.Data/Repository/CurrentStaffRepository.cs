...
{
    //public interface ICurrentStaffRepository : IRepository<Current_Staff>
    //{
    //    List<CurrentStaffDTO> QueryCurrentStaffInfo(CurrentStaffDTO dto, Page page, out int totalCount);
    //}

    //public class CurrentStaffRepository : RepositoryBase<Current_Staff>, ICurrentStaffRepository
    //{
