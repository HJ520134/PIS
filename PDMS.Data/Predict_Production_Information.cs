...
namespace PDMS.Data
{
    ...
    public partial class Predict_Production_Information
    {
        public int Predict_Production_Information_UID { get; set; }
        public int RP_Flowchart_Detail_ME_UID { get; set; }
        public System.DateTime Production_Date { get; set; }
        public int PP_Estimated_Input { get; set; }
        public decimal PP_Estimate_Yield { get; set; }
