...
{
    public class MaterialRepairDemandDTO:BaseModel
    {
        ...
        public int F3M_Damage_Qty { get; set; }
        public int F3M_PowerOn_Qty { get; set; }
        ...
        public decimal F3M_Damage_Rate { get; set; }
